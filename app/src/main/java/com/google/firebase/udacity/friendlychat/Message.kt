...
data class Message(var text: String?, var name: String?, var photoUrl: String?)

class MessageAdapter(context: Context, resource: Int, objects: List<Message>) : ArrayAdapter<Message>(context, resource, objects) {
